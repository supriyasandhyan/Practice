...
// export const varA = createContext();

const Parent = lazy(() =>
    import ('../src/HOC/Parent'));

const Web = lazy(() =>
    import ('./Components/Web'));
const Home = lazy(() =>
    import ('./UserAuthentication/Home'));
const Admin = lazy(() =>
    import ('./NestedRoute/Admin'));
const Dashboard = lazy(() =>
    import ('./UserAuthentication/Dashboard'));
const SignIn = lazy(() =>
...
function App() {
    ...
    const [clicking, setCliking] = useState(false)  
    ...
    const click =()=>{
        if (clicking===false){
            setCliking(true)
            setDisplay('supriya, uh clicking?')
        }else{
            setCliking(false)
            setDisplay('')
        }
    ...
    return ( 
        ...
        {/* <PublicRoute exact path = "/src/Form/FormNew.js" component = { FormNew } />  */}
        <PublicRoute exact path = "/src/HOC/Parent.js" component={ Parent } />
        <PublicRoute exact path = "/switchToggle" component = { SwitchToggle }/>
        <PublicRoute exact path = "/Refs" component = { Refs }/> 
        ...
        {/* <varA.Provider value={'supriyaSandhyan'}>
            <ContextApi />
        </varA.Provider> */}
